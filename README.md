...
### 🔍 Smart Features
- Search transactions by keyword (description, category, date, amount)
- Filter by:
  - All Entries
  - Income only
  - Expense only
...
### 💾 Data Persistence
- Uses LocalStorage (data remains after refresh)
...
<img width="1182" height="875" alt="image" src="https://github.com/user-attachments/assets/02a712c3-7de5-4da0-80a5-951cf630e97d" />
...
👨‍💻 Author
Name: Elefachew Fetene
Role: Beginner Full-Stack Developer
Goal: Becoming professional web developer
⭐ Project Status
